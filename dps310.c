...
int16_t read_coefs() {
    ...
    ret = wait_for_reg_value(
            ...
            DPS310_MEAS_CFG_COEF_RDY_AVAILABLE);
    ret=HAL_I2C_Mem_Read(&DPS310_I2C, I2C_DPS310_ADDRESS,DPS310_COEF_REG,I2C_MEMADD_SIZE_8BIT,&buff,18,1000);
...
int16_t write_byte_to_reg(uint8_t reg_addr, uint8_t data) {
    ...
    buff[0] = data;
    ret =HAL_I2C_Mem_Write(&DPS310_I2C, I2C_DPS310_ADDRESS, reg_addr, I2C_MEMADD_SIZE_8BIT, &buff, 1, 1000) ;
...
static int16_t read_temperature(float *p_temperature) {
    ...
    ret=HAL_I2C_Mem_Read(&DPS310_I2C, I2C_DPS310_ADDRESS,DPS310_TMP_B2_REG,I2C_MEMADD_SIZE_8BIT,&buff,3,1000);
...
int16_t read_pressure(float *p_pressure) {
	...
	ret=HAL_I2C_Mem_Read(&DPS310_I2C, I2C_DPS310_ADDRESS,DPS310_PSR_B2_REG,I2C_MEMADD_SIZE_8BIT,&buff,3,1000);
...
int16_t wait_for_reg_value(uint8_t reg_addr, uint8_t reg_value, uint8_t mask) {
    ...
    while (attempts < DPS310_READ_WAIT_FOR_REG_ATTEMPTS) {
        ...
        ret=HAL_I2C_Mem_Read(&DPS310_I2C, I2C_DPS310_ADDRESS,reg_addr,I2C_MEMADD_SIZE_8BIT,&buff,1,1000);
...
int16_t product_id_check() {
    ...
    uint8_t buff[1];
     ...
     ret=HAL_I2C_Mem_Read(&DPS310_I2C, I2C_DPS310_ADDRESS,DPS310_PRODUCT_ID_REG,I2C_MEMADD_SIZE_8BIT,&buff,1,1000);
...
int16_t get_temperature_sensor(uint8_t *p_sensor) {
    uint16_t ret;
    uint8_t buff[1];
    ret=HAL_I2C_Mem_Read(&DPS310_I2C, I2C_DPS310_ADDRESS,DPS310_TMP_COEF_SRCE,I2C_MEMADD_SIZE_8BIT,&buff,1,1000);

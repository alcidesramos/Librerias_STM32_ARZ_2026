...
//DEFINICONES PARA ACTIVAR MAS FACIL PIBES
...
//   fillScreen(ILI9488_BLUE);
  	//    	  fillScreen(ILI9488_WHITE);
  	  //  	draw_string(150, 280, "ALCIDES", COLOR_RED, font4);
  	//    draw_string_fondo(100, 100, "Maria",ILI9488_BLACK, ILI9488_CYAN, font3);
	    	// ILI9488_printText("HOLA", 200, 200, ILI9488_CYAN, ILI9488_BLACK, 1);
  	    	// setScrollArea(0, 0);
  	    	   // fillRect(0, 10, 480, 10, ILI9488_BLUE);
 //draw_bitmap(300, 0, 1, zorro);
 //draw_string(200,200 ,"ALCIDES",ILI9488_BLACK, font2);
  	    //	draw_line(0, 0,100,100, COLOR_BLUEVIOLET,3);

  	    //  draw_fill_rectangle(0,0, 100, 100, COLOR_BLUEVIOLET);
  	  // draw_rectangle(0,0, 100, 100, COLOR_BLUEVIOLET,3);
 //  draw_fill_triangulo(100, 0,50,100, 200, 100, COLOR_BLUE);
// draw_circulo(100, 100,50, COLOR_BLUEVIOLET,3);
  	 //	draw_fill_rectangulo_red(0,0, 100, 100, 5,COLOR_BLUEVIOLET);
  	 //   	draw_rectangulo_red(0,0, 100, 100, 5,COLOR_BLUEVIOLET,2);
  // draw_elipse(120, 80, 50, 30, COLOR_RED, 5);
  	 //draw_fill_elipse(120, 80, 50, 30, COLOR_BLUE);
/*
  led1.x=50;
  led1.y=250;
  led1.color_off=COLOR_LIGHTGREY;
  led1.color_on=COLOR_RED;
  led1.r=20;
*/


 /*
  en wl while por ejemplo

           	  gauge1.value = var;
	         //
            	// gauge_draw_arc(&gauge1);
